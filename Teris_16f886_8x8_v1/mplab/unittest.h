/*
This file contains functions to do unittest.
...
void ut_lg_is_row_full(const MATRIX8x8* matrix)
{
...
void ut_hit_land()
{
    ...
    dbg_print_MATRIX8x8(DEBUG_DISABLE, NULL, &matrix8x8);
    lg_hit_land(x, y, matrix4x4, &matrix8x8);
}
void ut_is_valid()
{
    int8_t x = 5, y = 7;
    ...
    dbg_print_MATRIX4x4(DEBUG_DISABLE, NULL, x, y, matrix4x4);
    dbg_print_MATRIX8x8(DEBUG_DISABLE, NULL, &matrix8x8);
    lg_is_valid(x, y, matrix4x4, &matrix8x8);
}
...
void ut_get_holes_after_merge()
{
    ...
    dbg_print_MATRIX8x8(DEBUG_DISABLE, NULL, &matrix8x8);
    lg_get_holes_after_merge(&matrix8x8);
}
